...
if(EXIST)
	...
	if(VERSION_HAS_BEEN_FOUND)#a good version of the package has been found
		...
		if(REQUIRED_PACKAGES_AUTOMATIC_DOWNLOAD)
			if(the-testpack-b_FIND_REQUIRED)		
				set(${PROJECT_NAME}_TOINSTALL_PACKAGES ${${PROJECT_NAME}_TOINSTALL_PACKAGES} the-testpack-b CACHE INTERNAL "")
				set(${PROJECT_NAME}_TOINSTALL_PACKAGE_the-testpack-b_VERSION "${the-testpack-b_FIND_VERSION_MAJOR}.${the-testpack-b_FIND_VERSION_MINOR}" CACHE INTERNAL "")
				if(the-testpack-b_FIND_VERSION_EXACT)
					set(${PROJECT_NAME}_TOINSTALL_PACKAGE_the-testpack-b_VERSION_EXACT TRUE CACHE INTERNAL "")
				else()
					set(${PROJECT_NAME}_TOINSTALL_PACKAGE_the-testpack-b_VERSION_EXACT FALSE CACHE INTERNAL "")
				endif()
			endif()
		else()
