...
if(EXIST)
	...
	if(VERSION_HAS_BEEN_FOUND)#a good version of the package has been found
		...
		if(REQUIRED_PACKAGES_AUTOMATIC_DOWNLOAD)
			if(the-testpack-c_FIND_REQUIRED)
				if(the-testpack-c_FIND_VERSION)
					add_To_Install_Package_Specification(the-testpack-c "${the-testpack-c_FIND_VERSION_MAJOR}.${the-testpack-c_FIND_VERSION_MINOR}" ${the-testpack-c_FIND_VERSION_EXACT})
				else()
					add_To_Install_Package_Specification(the-testpack-c "" FALSE)
				endif()
			endif()
		else()
