...
if(WITH_OFFICIAL STREQUAL "true")
	...
	if(HAS_MODIFS)
		...
		if(REMOTES)
			message("[PID] INFO : integration process is finished you can now push to origin and official.")
		else()
			message("[PID] INFO : integration process is finished, nothing to push to origin or official.")
		endif()
	endif()
	...
	get_Remotes_To_Update(REMOTES ${TARGET_PACKAGE})
	if(REMOTES)
		message("[PID] INFO : integration process is finished you can now push to origin.")
	else()
