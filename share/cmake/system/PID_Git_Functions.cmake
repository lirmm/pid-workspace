...
execute_process(COMMAND ${CMAKE_COMMAND} -E chdir ${WORKSPACE_DIR}/sites/frameworks/${framework} git lfs fetch master OUTPUT_QUIET ERROR_QUIET)#fetching master branch to get most up to date archives
