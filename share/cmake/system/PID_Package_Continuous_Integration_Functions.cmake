...
file(APPEND ${configfile} "compile_integration_${platform}:\n  <<: *compile_integration\n  <<: *selection_platform_${platform}\n\n")
file(APPEND ${configfile} "test_integration_${platform}:\n  <<: *test_integration\n  <<: *selection_platform_${platform}\n\n")
file(APPEND ${configfile} "install_integration_${platform}:\n  <<: *install_integration\n  <<: *selection_platform_${platform}\n\n")
...
file(APPEND ${configfile} "compile_release_${platform}:\n  <<: *compile_release\n  <<: *selection_platform_${platform}\n\n")
file(APPEND ${configfile} "test_release_${platform}:\n  <<: *test_release\n  <<: *selection_platform_${platform}\n\n")
file(APPEND ${configfile} "install_release_${platform}:\n  <<: *install_release\n  <<: *selection_platform_${platform}\n\n")
