...
function(get_Platform_Variables)
  set(oneValueArgs BASENAME INSTANCE PKG_STRING DISTRIBUTION DIST_VERSION)
...
if(EXISTS ${USE_FILE}) #file does not exists means the target version is not in development
	set(PID_VERSION_FILE ${WORKSPACE_DIR}/install/${curr_platform_str}/${package}/${version}/share/cmake/${package}_PID_Version.cmake)
