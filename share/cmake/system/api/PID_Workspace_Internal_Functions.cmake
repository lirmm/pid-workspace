...
file(APPEND ${file} "set(CMAKE_CXX_COMPILER_AR \"${CMAKE_CXX_COMPILER_AR}\" CACHE FILEPATH \"\" FORCE)\n")
file(APPEND ${file} "set(CMAKE_CXX_COMPILER_RANLIB \"${CMAKE_CXX_COMPILER_RANLIB}\" CACHE FILEPATH \"\" FORCE)\n")
...
file(APPEND ${file} "set(CMAKE_C_COMPILER_AR \"${CMAKE_C_COMPILER_AR}\" CACHE FILEPATH \"\" FORCE)\n")
file(APPEND ${file} "set(CMAKE_C_COMPILER_RANLIB \"${CMAKE_C_COMPILER_RANLIB}\" CACHE FILEPATH \"\" FORCE)\n")
...
file(APPEND ${file} "set(CMAKE_ASM_COMPILER \"${CMAKE_ASM_COMPILER}\" CACHE FILEPATH \"\" FORCE)\n")
file(APPEND ${file} "set(CMAKE_ASM_COMPILER_AR \"${CMAKE_ASM_COMPILER_AR}\" CACHE FILEPATH \"\" FORCE)\n")
file(APPEND ${file} "set(CMAKE_ASM_COMPILER_RANLIB \"${CMAKE_ASM_COMPILER_RANLIB}\" CACHE FILEPATH \"\" FORCE)\n")
file(APPEND ${file} "set(CMAKE_ASM_FLAGS \"${CMAKE_ASM_FLAGS}\" CACHE STRING \"\" FORCE)\n")
file(APPEND ${file} "set(CMAKE_ASM_FLAGS_DEBUG \"${CMAKE_ASM_FLAGS_DEBUG}\" CACHE STRING \"\" FORCE)\n")
file(APPEND ${file} "set(CMAKE_ASM_FLAGS_MINSIZEREL \"${CMAKE_ASM_FLAGS_MINSIZEREL}\" CACHE STRING \"\" FORCE)\n")
file(APPEND ${file} "set(CMAKE_ASM_FLAGS_RELEASE \"${CMAKE_ASM_FLAGS_RELEASE}\" CACHE STRING \"\" FORCE)\n")
file(APPEND ${file} "set(CMAKE_ASM_FLAGS_RELWITHDEBINFO \"${CMAKE_ASM_FLAGS_RELWITHDEBINFO}\" CACHE STRING \"\" FORCE)\n")
if(Python_Language_AVAILABLE)
	file(APPEND ${file} "set(PYTHON_EXECUTABLE \"${PYTHON_EXECUTABLE}\" CACHE FILEPATH \"\" FORCE)\n")
	file(APPEND ${file} "set(PYTHON_INCLUDE_DIR \"${PYTHON_INCLUDE_DIR}\" CACHE FILEPATH \"\" FORCE)\n")
	file(APPEND ${file} "set(PYTHON_LIBRARY \"${PYTHON_LIBRARY}\" CACHE FILEPATH \"\" FORCE)\n")
	file(APPEND ${file} "set(PYTHON_LIBRARY_DEBUG \"${PYTHON_LIBRARY_DEBUG}\" CACHE STRING \"\" FORCE)\n")
endif()
if(Fortran_Language_AVAILABLE)
	file(APPEND ${file} "set(CMAKE_Fortran_COMPILER \"${CMAKE_Fortran_COMPILER}\" CACHE FILEPATH \"\" FORCE)\n")
	file(APPEND ${file} "set(CMAKE_Fortran_COMPILER_AR \"${CMAKE_Fortran_COMPILER_AR}\" CACHE FILEPATH \"\" FORCE)\n")
	file(APPEND ${file} "set(CMAKE_Fortran_COMPILER_RANLIB \"${CMAKE_Fortran_COMPILER_RANLIB}\" CACHE FILEPATH \"\" FORCE)\n")
	file(APPEND ${file} "set(CMAKE_Fortran_FLAGS \"${CMAKE_Fortran_FLAGS}\" CACHE STRING \"\" FORCE)\n")
	file(APPEND ${file} "set(CMAKE_Fortran_FLAGS_DEBUG \"${CMAKE_Fortran_FLAGS_DEBUG}\" CACHE STRING \"\" FORCE)\n")
	file(APPEND ${file} "set(CMAKE_Fortran_FLAGS_MINSIZEREL \"${CMAKE_Fortran_FLAGS_MINSIZEREL}\" CACHE STRING \"\" FORCE)\n")
	file(APPEND ${file} "set(CMAKE_Fortran_FLAGS_RELEASE \"${CMAKE_Fortran_FLAGS_RELEASE}\" CACHE STRING \"\" FORCE)\n")
	file(APPEND ${file} "set(CMAKE_Fortran_FLAGS_RELWITHDEBINFO \"${CMAKE_Fortran_FLAGS_RELWITHDEBINFO}\" CACHE STRING \"\" FORCE)\n")
endif()
if(CUDA_Language_AVAILABLE)
	if(CUDA_CMAKE_SUPPORT STREQUAL "NEW") #these flags have been set by the enable_language(CUDA) command
		file(APPEND ${file} "set(CMAKE_CUDA_COMPILER \"${CMAKE_CUDA_COMPILER}\" CACHE FILEPATH \"\" FORCE)\n")
		file(APPEND ${file} "set(CMAKE_CUDA_FLAGS \"${CMAKE_CUDA_FLAGS}\" CACHE STRING \"\" FORCE)\n")
		file(APPEND ${file} "set(CMAKE_CUDA_FLAGS_DEBUG \"${CMAKE_CUDA_FLAGS_DEBUG}\" CACHE STRING \"\" FORCE)\n")
		file(APPEND ${file} "set(CMAKE_CUDA_FLAGS_MINSIZEREL \"${CMAKE_CUDA_FLAGS_MINSIZEREL}\" CACHE STRING \"\" FORCE)\n")
		file(APPEND ${file} "set(CMAKE_CUDA_FLAGS_RELEASE \"${CMAKE_CUDA_FLAGS_RELEASE}\" CACHE STRING \"\" FORCE)\n")
		file(APPEND ${file} "set(CMAKE_CUDA_FLAGS_RELWITHDEBINFO \"${CMAKE_CUDA_FLAGS_RELWITHDEBINFO}\" CACHE STRING \"\" FORCE)\n")
	endif()

	#adding information about old "way of doing"
	file(APPEND ${file} "set(CUDA_64_BIT_DEVICE_CODE \"${CUDA_64_BIT_DEVICE_CODE}\" CACHE BOOL \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_ATTACH_VS_BUILD_RULE_TO_CUDA_FILE \"${CUDA_ATTACH_VS_BUILD_RULE_TO_CUDA_FILE}\" CACHE BOOL \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_BUILD_CUBIN \"${CUDA_BUILD_CUBIN}\" CACHE BOOL \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_BUILD_EMULATION \"${CUDA_BUILD_EMULATION}\" CACHE BOOL \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_LIBRARIES \"${CUDA_LIBRARIES}\" CACHE FILEPATH \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_INCLUDE_DIRS \"${CUDA_INCLUDE_DIRS}\" CACHE FILEPATH \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_CUDART_LIBRARY \"${CUDA_CUDART_LIBRARY}\" CACHE FILEPATH \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_CUDA_LIBRARY: \"${CUDA_CUDA_LIBRARY}\" CACHE FILEPATH \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_NVCC_EXECUTABLE \"${CUDA_NVCC_EXECUTABLE}\" CACHE FILEPATH \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_HOST_COMPILER \"${CUDA_HOST_COMPILER}\" CACHE FILEPATH \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_HOST_COMPILATION_CPP \"${CUDA_HOST_COMPILATION_CPP}\" CACHE FILEPATH \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_GENERATED_OUTPUT_DIR \"${CUDA_GENERATED_OUTPUT_DIR}\" CACHE FILEPATH \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_NVCC_FLAGS \"${CUDA_NVCC_FLAGS}\" CACHE STRING \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_NVCC_FLAGS_DEBUG \"${CUDA_NVCC_FLAGS_DEBUG}\" CACHE STRING \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_NVCC_FLAGS_MINSIZEREL \"${CUDA_NVCC_FLAGS_MINSIZEREL}\" CACHE STRING \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_NVCC_FLAGS_RELEASE \"${CUDA_NVCC_FLAGS_RELEASE}\" CACHE STRING \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_NVCC_FLAGS_RELWITHDEBINFO \"${CUDA_NVCC_FLAGS_RELWITHDEBINFO}\" CACHE STRING \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_PROPAGATE_HOST_FLAGS \"${CUDA_PROPAGATE_HOST_FLAGS}\" CACHE BOOL \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_SEPARABLE_COMPILATION \"${CUDA_SEPARABLE_COMPILATION}\" CACHE BOOL \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_SDK_ROOT_DIR \"${CUDA_SDK_ROOT_DIR}\" CACHE FILEPATH \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_TOOLKIT_INCLUDE \"${CUDA_TOOLKIT_INCLUDE}\" CACHE FILEPATH \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_TOOLKIT_ROOT_DIR \"${CUDA_TOOLKIT_ROOT_DIR}\" CACHE FILEPATH \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_VERSION \"${CUDA_VERSION}\" CACHE FILEPATH \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_cublas_LIBRARY \"${CUDA_cublas_LIBRARY}\" CACHE FILEPATH \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_cudadevrt_LIBRARY \"${CUDA_cudadevrt_LIBRARY}\" CACHE FILEPATH \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_cublas_device_LIBRARY \"${CUDA_cublas_device_LIBRARY}\" CACHE FILEPATH \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_cudart_static_LIBRARY \"${CUDA_cudart_static_LIBRARY}\" CACHE FILEPATH \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_cufft_LIBRARY \"${CUDA_cufft_LIBRARY}\" CACHE FILEPATH \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_cupti_LIBRARY \"${CUDA_cupti_LIBRARY}\" CACHE FILEPATH \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_curand_LIBRARY \"${CUDA_curand_LIBRARY}\" CACHE FILEPATH \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_cusolver_LIBRARY \"${CUDA_cusolver_LIBRARY}\" CACHE FILEPATH \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_cusparse_LIBRARY \"${CUDA_cusparse_LIBRARY}\" CACHE FILEPATH \"\" FORCE)\n")
	file(APPEND ${file} "set(CUDA_nppc_LIBRARY \"${CUDA_nppc_LIBRARY}\" CACHE FILEPATH \"\" FORCE)\n")
	...
	file(APPEND ${file} "set(DEFAULT_CUDA_DRIVER \"${DEFAULT_CUDA_DRIVER}\" CACHE STRING \"\" FORCE)\n")
	file(APPEND ${file} "set(DEFAULT_CUDA_RUNTIME \"${DEFAULT_CUDA_RUNTIME}\" CACHE STRING \"\" FORCE)\n")
