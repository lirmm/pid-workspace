...
macro(declare_PID_External_Package)
	...
	if(NOT ${package}_DECLARED)
		set(${package}_PLATFORM  CACHE INTERNAL "")
		set(${package}_PLATFORM_CONFIGURATIONS  CACHE INTERNAL "")
		if(${package}_EXTERNAL_DEPENDENCIES)
			foreach(dep IN ITEMS ${${package}_EXTERNAL_DEPENDENCIES})
				set(${package}_EXTERNAL_DEPENDENCY_${dep}_VERSION CACHE INTERNAL "")
				set(${package}_EXTERNAL_DEPENDENCY_${dep}_VERSION_EXACT CACHE INTERNAL "")
			endforeach()
		endif()
		set(${package}_EXTERNAL_DEPENDENCIES CACHE INTERNAL "")
		if(${package}_COMPONENTS)
			foreach(comp IN ITEMS ${${package}_COMPONENTS})
				#resetting variables of the component
				set(${package}_${comp}_INC_DIRS CACHE INTERNAL "")
				set(${package}_${comp}_OPTS CACHE INTERNAL "")
				set(${package}_${comp}_DEFS CACHE INTERNAL "")
				set(${package}_${comp}_LINKS CACHE INTERNAL "")
				set(${package}_${comp}_RUNTIME_RESOURCES CACHE INTERNAL "")
				set(${package}_${comp}_INTERNAL_DEPENDENCIES CACHE INTERNAL "")
				if(${package}_${comp}_EXTERNAL_DEPENDENCIES)
					foreach(dep_pack IN ITEMS ${${package}_${comp}_EXTERNAL_DEPENDENCIES})
						if(${package}_${comp}_EXTERNAL_DEPENDENCY_${dep_pack}_COMPONENTS)
							foreach(dep_comp IN ITEMS ${${package}_${comp}_EXTERNAL_DEPENDENCY_${dep_pack}_COMPONENTS})
								set(${package}_${comp}_EXTERNAL_EXPORT_${dep_pack}_${dep_comp} CACHE INTERNAL "")
							endforeach()
							set(${package}_${comp}_EXTERNAL_DEPENDENCY_${dep_pack}_COMPONENTS CACHE INTERNAL "")
						endif()
					endforeach()
					set(${package}_${comp}_EXTERNAL_DEPENDENCIES CACHE INTERNAL "")
				endif()
			endforeach()
		endif()
	else()
...
macro(declare_PID_External_Package_Dependency)
	...
	if(DECLARE_PID_EXTERNAL_DEPENDENCY_PACKAGE
		...
		if(NOT ${package}_EXTERNAL_DEPENDENCY_${dependency}_VERSION)
			set(${package}_EXTERNAL_DEPENDENCIES ${${package}_EXTERNAL_DEPENDENCIES} ${dependency} CACHE INTERNAL "")
			set(${package}_EXTERNAL_DEPENDENCY_${dependency}_VERSION ${DECLARE_PID_EXTERNAL_DEPENDENCY_VERSION} CACHE INTERNAL "")
			set(${package}_EXTERNAL_DEPENDENCY_${dependency}_VERSION_EXACT ${exact} CACHE INTERNAL "")
		else()
		...
		message("[PID] WARNING: Bad usage of function declare_PID_External_Package_Dependency: PACKAGE (value: ${package}), EXTERNAL (value: ${dependency}) and VERSION (value: ${DECLARE_PID_EXTERNAL_DEPENDENCY_VERSION}) keywords must be used !")
		return() #return will exit from current Use file included (because we are in a macro)
	endif()
...
macro(declare_PID_External_Component)
	...
	set(comps_list ${${curr_ext_package}_COMPONENTS} ${curr_ext_comp})
	list(REMOVE_DUPLICATES comps_list)
	set(${curr_ext_package}_COMPONENTS ${comps_list} CACHE INTERNAL "")
	...
	if(incs)
		...
		set(${curr_ext_package}_${curr_ext_comp}_INC_DIRS ${incs} CACHE INTERNAL "")
	endif()
	#manage compile options
	set(${curr_ext_package}_${curr_ext_comp}_OPTS ${DECLARE_PID_EXTERNAL_COMPONENT_COMPILER_OPTIONS} CACHE INTERNAL "")
	#manage definitions
	set(${curr_ext_package}_${curr_ext_comp}_DEFS ${DECLARE_PID_EXTERNAL_COMPONENT_DEFINITIONS} CACHE INTERNAL "")
	...
	if(links)
		...
		set(${curr_ext_package}_${curr_ext_comp}_LINKS ${links} CACHE INTERNAL "")
	endif()
	...
	if(resources)
		list(REMOVE_DUPLICATES links)
		set(${curr_ext_package}_${curr_ext_comp}_RUNTIME_RESOURCES ${resources} CACHE INTERNAL "")
	endif()
...
macro(declare_PID_External_Component_Dependency)
	...
	if(TARGET_COMPONENT)
		if(NOT TARGET_PACKAGE)
			set(list_of_comps ${${LOCAL_PACKAGE}_${LOCAL_COMPONENT}_INTERNAL_DEPENDENCIES} ${TARGET_COMPONENT})
			list(REMOVE_DUPLICATES list_of_comps)
			set(${LOCAL_PACKAGE}_${LOCAL_COMPONENT}_INTERNAL_DEPENDENCIES ${list_of_comps} CACHE INTERNAL "")
			set(${LOCAL_PACKAGE}_${LOCAL_COMPONENT}_INTERNAL_EXPORT_${TARGET_COMPONENT} ${EXPORT_TARGET} CACHE INTERNAL "")
		else()
			set(list_of_deps ${${LOCAL_PACKAGE}_${LOCAL_COMPONENT}_EXTERNAL_DEPENDENCIES} ${TARGET_PACKAGE})
			list(REMOVE_DUPLICATES list_of_deps)
			set(${LOCAL_PACKAGE}_${LOCAL_COMPONENT}_EXTERNAL_DEPENDENCIES ${list_of_deps} CACHE INTERNAL "")
			set(list_of_comps ${${LOCAL_PACKAGE}_${LOCAL_COMPONENT}_EXTERNAL_DEPENDENCY_${TARGET_PACKAGE}_COMPONENTS} ${TARGET_COMPONENT})
			list(REMOVE_DUPLICATES list_of_comps)
			set(${LOCAL_PACKAGE}_${LOCAL_COMPONENT}_EXTERNAL_DEPENDENCY_${TARGET_PACKAGE}_COMPONENTS ${list_of_comps} CACHE INTERNAL "")
			set(${LOCAL_PACKAGE}_${LOCAL_COMPONENT}_EXTERNAL_EXPORT_${TARGET_PACKAGE}_${TARGET_COMPONENT} ${EXPORT_TARGET} CACHE INTERNAL "")
		endif()
...
if(TARGET_PACKAGE AND NOT TARGET_COMPONENT) #if a target package is specified but not a component
	set(incs ${${LOCAL_PACKAGE}_${LOCAL_COMPONENT}_INC_DIRS})
	...
	set(${LOCAL_PACKAGE}_${LOCAL_COMPONENT}_INC_DIRS ${incs} CACHE INTERNAL "")

	#manage compile options
	set(opts ${${LOCAL_PACKAGE}_${LOCAL_COMPONENT}_OPTS} ${DECLARE_PID_EXTERNAL_COMPONENT_DEPENDENCY_COMPILER_OPTIONS})
	if(opts)
		list(REMOVE_DUPLICATES opts)
	endif()
	set(${LOCAL_PACKAGE}_${LOCAL_COMPONENT}_OPTS ${opts} CACHE INTERNAL "")
	#manage definitions
	set(defs ${${LOCAL_PACKAGE}_${LOCAL_COMPONENT}_DEFS} ${DECLARE_PID_EXTERNAL_COMPONENT_DEPENDENCY_DEFINITIONS})
	if(defs)
		list(REMOVE_DUPLICATES defs)
	endif()
	set(${LOCAL_PACKAGE}_${LOCAL_COMPONENT}_DEFS ${defs} CACHE INTERNAL "")
	#manage links
	set(links ${${LOCAL_PACKAGE}_${LOCAL_COMPONENT}_LINKS})
	if(DECLARE_PID_EXTERNAL_COMPONENT_DEPENDENCY_LINKS)
		foreach(a_link IN ITEMS ${DECLARE_PID_EXTERNAL_COMPONENT_DEPENDENCY_LINKS})
			if(a_link MATCHES  "^(<${curr_ext_package}>|/|-).*")
				list(APPEND links ${a_link})
			else()
	...
	set(${LOCAL_PACKAGE}_${LOCAL_COMPONENT}_LINKS ${links} CACHE INTERNAL "")

	#manage runtime resources
	set(resources ${${LOCAL_PACKAGE}_${LOCAL_COMPONENT}_RUNTIME_RESOURCES})
	...
	set(${LOCAL_PACKAGE}_${LOCAL_COMPONENT}_RUNTIME_RESOURCES ${resources} CACHE INTERNAL "")
endif()
