...
set(oneValueArgs FRAMEWORK HOME GIT ADVANCED TUTORIAL LOGO)
...
if(NOT DECLARE_PID_DOCUMENTATION_FRAMEWORK AND NOT DECLARE_PID_DOCUMENTATION_HOME)
	message(FATAL_ERROR "[PID] CRITICAL ERROR : bad arguments, you must tell either where to find the static site of the package (using HOME keyword) or to which framework the package contributes to (using FRAMEWORK keyword).")
endif()
if(DECLARE_PID_DOCUMENTATION_FRAMEWORK)
	...
	if(NOT DECLARE_PID_DOCUMENTATION_GIT)
		message(FATAL_ERROR "[PID] CRITICAL ERROR : bad arguments, you must tell where to find the repository for the static site of the package (using GIT keyword).")
	endif()
