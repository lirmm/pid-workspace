...
### API : declare_PID_Wiki()
macro(declare_PID_Wiki)
set(oneValueArgs GIT_ADDRESS HOME_PAGE PARENT_PAGE SPECIFIC_CONTENT)
...
if(NOT DECLARE_PID_WIKI_GIT_ADDRESS)
	message(FATAL_ERROR "bad arguments : you need to set the repository address for the project wiki")
endif()
