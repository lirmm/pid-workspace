...
set(oneValueArgs HOME FRAMEWORK GIT PAGE ADVANCED TUTORIAL LOGO)
set(multiValueArgs DESCRIPTION)
cmake_parse_arguments(DECLARE_PID_DOCUMENTATION "" "${oneValueArgs}" "${multiValueArgs}" ${ARGN} )
if(NOT DECLARE_PID_DOCUMENTATION_HOME)
	message(FATAL_ERROR "[PID] CRITICAL ERROR : bad arguments, you must tell where to find the project page of the official package repository using HOME keyword.")
endif()

if(NOT DECLARE_PID_DOCUMENTATION_FRAMEWORK AND NOT DECLARE_PID_DOCUMENTATION_GIT)
...
if(DECLARE_PID_DOCUMENTATION_FRAMEWORK)
	define_Framework_Contribution("${DECLARE_PID_DOCUMENTATION_FRAMEWORK}" "${DECLARE_PID_DOCUMENTATION_DESCRIPTION}")
else()#DECLARE_PID_DOCUMENTATION_HOME
	if(NOT DECLARE_PID_DOCUMENTATION_PAGE)
	...
	define_Static_Site_Contribution("${DECLARE_PID_DOCUMENTATION_HOME}" "${DECLARE_PID_DOCUMENTATION_GIT}" "${DECLARE_PID_DOCUMENTATION_PAGE}" "${DECLARE_PID_DOCUMENTATION_DESCRIPTION}")
endif()
#user defined doc
...
if(DECLARE_PID_DOCUMENTATION_TUTORIAL)
	define_Documentation_Content(tutorial "${DECLARE_PID_DOCUMENTATION_TUTORIAL}")
else()
	define_Documentation_Content(tutorial FALSE)
endif()
if(DECLARE_PID_DOCUMENTATION_LOGO)
	define_Documentation_Content(logo "${DECLARE_PID_DOCUMENTATION_LOGO}")
else()
