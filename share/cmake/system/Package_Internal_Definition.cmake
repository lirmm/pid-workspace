...
elseif (APPLE)
	...
	set(CMAKE_INSTALL_RPATH "../lib") #the default install rpath is the library folder of the installed package (internal libraries managed by default), name is relative to @rpath to enable easy package relocation
endif()
...
if(NOT ${PROJECT_NAME}_${c_name}_TYPE STREQUAL "HEADER")
	...
	elseif(${PROJECT_NAME}_${c_name}_TYPE STREQUAL "SHARED")
		...
		elseif(APPLE)
			set_target_properties(${c_name}${INSTALL_NAME_SUFFIX} PROPERTIES INSTALL_RPATH "${CMAKE_INSTALL_RPATH};../.rpath/${c_name}${INSTALL_NAME_SUFFIX}") #the library targets a specific folder that contains symbolic links to used shared libraries
		else()
