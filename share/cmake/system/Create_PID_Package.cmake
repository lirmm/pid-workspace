...
if(REQUIRED_PACKAGE)
	...
	if(NOT REQUIRED_STATUS STREQUAL NOTFOUND)
		message("[PID] ERROR : A package with the same name ${REQUIRED_PACKAGE} is already referenced in the workspace.")
		return()
	endif()
	if(EXISTS ${WORKSPACE_DIR}/packages/${REQUIRED_PACKAGE} AND IS_DIRECTORY ${WORKSPACE_DIR}/packages/${REQUIRED_PACKAGE})
		message("[PID] ERROR : A package with the same name ${REQUIRED_PACKAGE} is already present in the workspace.")
		return()
	endif()
	if(OPTIONAL_LICENSE)
