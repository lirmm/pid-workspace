...
if(push_site)
	...
	set(COUNTER 0)
	while(CONTINUE)
		if(COUNTER GREATER 180)# 15 min. trying to pull => STOP
			set(CONTINUE FALSE)
			break()
		elseif(COUNTER GREATER 1)
			message("[PID] INFO: waiting 5 seconds before publishing again the result...")
			execute_process(COMMAND ${CMAKE_COMMAND} -E sleep 5  OUTPUT_QUIET ERROR_QUIET) #waiting 30 seconds before repulling again
		endif()
