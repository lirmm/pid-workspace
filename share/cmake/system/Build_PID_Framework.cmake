...
file(COPY ${PATH_TO_FRAMEWORK_SRC}/assets ${PATH_TO_FRAMEWORK_SRC}/packages ${PATH_TO_FRAMEWORK_SRC}/pages ${PATH_TO_FRAMEWORK_SRC}/_posts DESTINATION ${PATH_TO_FRAMEWORK_JEKYLL})


#2) build site with jekyll

execute_process(COMMAND jekyll build -d ${PATH_TO_FRAMEWORK_RESULT} WORKING_DIRECTORY ${PATH_TO_FRAMEWORK_JEKYLL})
