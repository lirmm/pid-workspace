...
function(configure_Environment_Tool)
  ...
  set(monoValueArgs SYSROOT STAGING LANGUAGE COMPILER INTERPRETER NM OBJDUMP OBJCOPY LIBRARY AR RANLIB LINKER GENERATOR TOOLSET)
  ...
  elseif(CONF_ENV_TOOL_SYSTEM)
    ...
    if(CONF_ENV_TOOL_TOOLSET)
      set(${PROJECT_NAME}_GENERATOR_TOOLSET ${CONF_ENV_TOOL_TOOLSET} CACHE INTERNAL "")
    endif()
...
function(get_Environment_Target_Platform)
  set(monoValueArgs DISTRIBUTION DISTRIB_VERSION TYPE ARCH OS ABI CONFIGURATION)
