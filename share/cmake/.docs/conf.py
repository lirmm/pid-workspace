...
project = u'PID CMake API documentation'
author = u'CNRS LIRMM / JRL'
copyright = u'2017-2018, {}'.format(author)
...
htmlhelp_basename = 'PIDCMakeAPIdoc'
...
texinfo_documents = [
  ('index', 'PIDCMakeAPI', project,
   author, 'PIDCMakeAPI', 'One line description of project.',
   'Miscellaneous'),
]
