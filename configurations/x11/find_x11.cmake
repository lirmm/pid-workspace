...
if (UNIX)
	...
	if(IS_FOUND)
		...
		extract_Soname_From_PID_Libraries(X11_LIBRARIES X11_SONAME)
	...
	if(IS_FOUND)
		...
		extract_Soname_From_PID_Libraries(X11_EXT_LIBRARIES X11_EXT_SONAME)
		list(APPEND X11_SONAME ${X11_EXT_SONAME})
	endif()
