...
if (UNIX)
	...
	if(NOT posix_pthread_INCLUDE_PATH
		...
		OR NOT posix_math_INCLUDE_PATH)
		set(POSIX_INCS)
		set(IS_FOUND FALSE)
	...
	find_PID_Library_In_Linker_Order(m IMPLICIT m_LIBRARY_PATH m_SONAME)
	if(NOT m_LIBRARY_PATH)
		message("[PID] ERROR : when finding posix, cannot find math library.")
		set(IS_FOUND FALSE)
	endif()

	if(IS_FOUND)
		set(POSIX_INCS ${posix_pthread_INCLUDE_PATH} ${posix_rt_INCLUDE_PATH} ${posix_dl_INCLUDE_PATH} ${posix_math_INCLUDE_PATH} )
		set(POSIX_SONAME ${pthread_SONAME} ${rt_SONAME} ${dl_SONAME} ${m_SONAME} )
		set(POSIX_LIBS ${pthread_LIBRARY_PATH} ${rt_LIBRARY_PATH} ${dl_LIBRARY_PATH} ${m_LIBRARY_PATH})
