...
if(NOT gtk3_FOUND)
	...
	# trying to find gtk3
	include(${WORKSPACE_DIR}/configurations/gtk3/find_gtk3.cmake)
	if(gtk3_FOUND)
		set(gtk3_INCLUDE_DIRS ${gtk3_INCLUDE_PATH} CACHE INTERNAL "")
		set(all_links)
		foreach(lib IN LISTS gtk3_LIBRARIES)
			convert_Library_Path_To_Default_System_Library_Link(res_link ${lib})
			list(APPEND all_links ${res_link})
		endforeach()
		set(gtk3_LINK_OPTIONS ${all_links} CACHE INTERNAL "") #simply adding all gtk3 standard libraries
		set(CHECK_gtk3_RESULT TRUE)
	else()
		include(${WORKSPACE_DIR}/configurations/gtk3/install_gtk3.cmake)
		if(gtk3_INSTALLED)
			set(all_links)
			foreach(lib IN LISTS gtk3_LIBRARIES)
				convert_Library_Path_To_Default_System_Library_Link(res_link ${lib})
