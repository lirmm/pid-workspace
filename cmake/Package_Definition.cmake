...
if(DECLARE_PID_DEPENDENCY_UNPARSED_ARGUMENTS)
  ...
  if(NOT PARSE_RESULT)#error during parsing process
    finish_Progress(${GLOBAL_PROGRESS_VAR})
    message(FATAL_ERROR "[PID] CRITICAL ERROR : bad arguments when declaring dependency to package ${name_of_dependency}, see previous messages.")
  endif()
endif()
...
if(REMAINING_TO_PARSE) #there are still components to parse
	...
	if(DECLARE_PID_DEPENDENCY_MORE_COMPONENTS)
		...
		if(SIZE LESS 1)
      finish_Progress(${GLOBAL_PROGRESS_VAR})
			message(FATAL_ERROR "[PID] CRITICAL ERROR : bad arguments when declaring dependency to package ${name_of_dependency}, at least one component dependency must be defined when using the COMPONENTS keyword.")
		endif()
