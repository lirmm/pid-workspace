...
macro(check_PID_Environment)
  ...
  set(target_env)#used to store expression that possibly defines a plugin
  ...
  if(CHECK_PID_ENV_LANGUAGE)
    ...
    set(target_env "${CHECK_PID_ENV_TOOLSET}")#only toolsets can activate a plugin
  elseif(CHECK_PID_ENV_TOOL)
    check_Environment_Tool_Constraints(ERROR  "${CHECK_PID_ENV_TOOL}")
    set(target_env "${CHECK_PID_ENV_TOOL}")
  endif()
