...
if(TARGET_PACKAGE)
	...
	elseif(EXISTS ${WORKSPACE_DIR}/wrappers/${TARGET_PACKAGE}
		...
		message(FATAL_ERROR "[PID] ERROR : the package to be removed, named ${TARGET_PACKAGE}, does not lies in the workspace.")
	endif()
elseif(TARGET_FRAMEWORK)
	if(EXISTS ${WORKSPACE_DIR}/sites/frameworks/${TARGET_FRAMEWORK}
		...
		message(FATAL_ERROR "[PID] ERROR : the framework to be removed, named ${TARGET_FRAMEWORK}, does not lies in the workspace.")
	endif()
elseif(TARGET_ENVIRONMENT)
	...
	AND IS_DIRECTORY ${WORKSPACE_DIR}/environments/${TARGET_ENVIRONMENT})
		...
		message(FATAL_ERROR "[PID] ERROR : the environment to be removed, named ${TARGET_ENVIRONMENT}, does not lies in the workspace.")
	endif()
else()
