...
if(CURRENT_GENERATOR_EXTRA)
	set(CMAKE_EXTRA_GENERATOR "${CURRENT_GENERATOR_EXTRA}")
endif()
...
if(NOT EVAL_OK)
  message(FATAL_ERROR "[PID] CRITICAL ERROR : cannot evaluate environment ${TARGET_ENVIRONMENT} on current host.")
  return()
endif()
