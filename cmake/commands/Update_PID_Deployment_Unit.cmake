	...
	if(TARGET_PACKAGE STREQUAL "all")
		...
		if(PACK_TYPE STREQUAL "NATIVE")
			if(EXISTS ${WORKSPACE_DIR}/packages/${TARGET_PACKAGE}
				 ...
				 if(UPDATE_OK)
				 		deploy_Source_Native_Package(INSTALLED ${TARGET_PACKAGE} "${version_dirs}" FALSE "${${TARGET_PACKAGE}_BUILT_RELEASE_ONLY}")
				 else()
			...
			AND IS_DIRECTORY ${WORKSPACE_DIR}/wrappers/${TARGET_PACKAGE})
				...
				if(UPDATE_OK)
					deploy_Source_External_Package(INSTALLED ${TARGET_PACKAGE} "${version_dirs}" "${${TARGET_PACKAGE}_BUILT_RELEASE_ONLY}")
				else()
					message("[PID] WARNING : nothing updated, abort")
				endif()
			 endif()
