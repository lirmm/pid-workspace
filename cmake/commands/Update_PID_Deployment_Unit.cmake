	...
	if(TARGET_PACKAGE STREQUAL "all")
		...
		if(PACK_TYPE STREQUAL "NATIVE")
			if(EXISTS ${WORKSPACE_DIR}/packages/${TARGET_PACKAGE}
				 ...
				 if(EXISTS ${WORKSPACE_DIR}/packages/${TARGET_PACKAGE}/build/Package_Build_Info.cmake)
				 	include(${WORKSPACE_DIR}/packages/${TARGET_PACKAGE}/build/Package_Build_Info.cmake NO_POLICY_SCOPE)#loading the package description
				 endif()
				 ...
				 if(UPDATE_OK)
				 		deploy_Source_Native_Package(INSTALLED ${TARGET_PACKAGE} "${version_dirs}" FALSE "${${TARGET_PACKAGE}_BUILD_RELEASE_ONLY}")
				 else()
					 message("[PID] WARNING : nothing updated, abort")
				 endif()
			 endif()
		else()
			if(EXISTS ${WORKSPACE_DIR}/wrappers/${TARGET_PACKAGE}
			AND IS_DIRECTORY ${WORKSPACE_DIR}/wrappers/${TARGET_PACKAGE})
				if(EXISTS ${WORKSPACE_DIR}/wrappers/${TARGET_PACKAGE}/build/Build${TARGET_PACKAGE}.cmake)
					include(${WORKSPACE_DIR}/wrappers/${TARGET_PACKAGE}/build/Build${TARGET_PACKAGE}.cmake NO_POLICY_SCOPE)#loading the wrapper description
				endif()
				...
				if(UPDATE_OK)
					deploy_Source_External_Package(INSTALLED ${TARGET_PACKAGE} "${version_dirs}" "${${TARGET_PACKAGE}_BUILD_RELEASE_ONLY}")
				else()
					message("[PID] WARNING : nothing updated, abort")
				endif()
			 endif()
