...
set(cmd_list "ls|add|rm|reset|churl|prio_max|prio_min|move|copy|publish|update|status|delete|clean")
...
elseif(TARGET_COMMAND STREQUAL "status")
  ...
  get_Contribution_Space_Repository_Status(LIST_TO_ADD LIST_TO_COMMIT ${TARGET_CS})
  set(all_to_update ${LIST_TO_ADD} ${LIST_TO_COMMIT})
  if(all_to_update)
    get_Name_Of_Contributions_From_Modified_Files(LIST_OF_PACKAGES LIST_OF_FRAMEWORKS
                                                  ...
                                                  "${all_to_update}")
    message("[PID] INFO: contributions to publish in ${TARGET_CS}")
    if(LIST_OF_PACKAGES)
