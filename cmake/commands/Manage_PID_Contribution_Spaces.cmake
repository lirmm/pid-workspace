...
elseif(NOT TARGET_COMMAND MATCHES "^ls|reset$")
  ...
  if(TARGET_COMMAND STREQUAL "add")
    if(NOT UPDATE_URL)
      message(FATAL_ERROR "[PID] ERROR :when managing contribution spaces, command add requires argument update (url where to get last updates of the contribution space) to be defined.")
    endif()
