...
if(include_installer)
	if(NOT TARGET_REGISTRY)
		...
		if(NOT AVAILABLE)
			message("[PID] ERROR : cannot upload package ${TARGET_PACKAGE} binaries into registry because CURL tool is not available.")
			set(include_installer FALSE)
		else()
			...
			if(is_native)
				...
				if(NOT UPLOADED)
					message("[PID] ERROR : cannot upload package ${TARGET_PACKAGE} binaries (version=${TARGET_VERSION}) into registry (${TARGET_REGISTRY}). Aborting to avoid inconsistency between package register and web site description")
					set(include_installer FALSE)
				endif()
			else()
				...
				if(NOT bin_versions_to_document)
					message("[PID] ERROR : cannot upload package ${TARGET_PACKAGE} binaries (version=${TARGET_VERSION}) into registry (${TARGET_REGISTRY}) because nothing can be upload.")
					set(include_installer FALSE)
				endif()
			endif()
		endif()
