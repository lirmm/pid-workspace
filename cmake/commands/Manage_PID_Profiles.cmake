...
if(TARGET_ABI)
	if(TARGET_ABI STREQUAL "abi98" OR TARGET_ABI STREQUAL "98" OR TARGET_ABI STREQUAL "CXX")
		set(TARGET_ABI 98 CACHE INTERNAL "" FORCE)
	elseif(TARGET_ABI STREQUAL "abi11" OR TARGET_ABI STREQUAL "11" OR TARGET_ABI STREQUAL "CXX11")
		set(TARGET_ABI 11 CACHE INTERNAL "" FORCE)
	else()
		message(FATAL_ERROR "[PID] ERROR when using the command ${TARGET_COMMAND}, unknown ABI specified: ${TARGET_ABI}. Use the argument \"abi\" with value 98 or 11.")
	endif()
endif()
