...
function(write_Platform_Reporting_File file)
  ...
  if(Python_Language_AVAILABLE)
    set(WORKSPACE_CONFIGURATION_DESCRIPTION "${WORKSPACE_CONFIGURATION_DESCRIPTION}[PID] INFO : Python language available (version ${CURRENT_PYTHON}). To use python modules installed in workspace please set the PYTHONPATH to =${WORKSPACE_DIR}/install/${CURRENT_PLATFORM}/__python${CURRENT_PYTHON}__\n")
  endif()
...
macro(evaluate_Platform_Configuration config path_to_config)
  ...
  if(ADDITIONAL_DEBUG_INFO)
    set(options)
    set(calling_defs "-DADDITIONAL_DEBUG_INFO=ON ${calling_defs}")
  else()
