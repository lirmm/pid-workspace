...
function(reset_Wrapper_Version_Info version buidable soname compatibility deploy_file_name post_install_script pre_use_script cmake_folder pkgconfig_folder)
	...
	foreach(lang IN LISTS ${PROJECT_NAME}_KNOWN_VERSION_${version}_LANGUAGE_CONFIGURATIONS)
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_LANGUAGE_CONFIGURATION_${lang}_ARGS CACHE)
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_LANGUAGE_CONFIGURATION_${lang}_OPTIONAL CACHE)
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_LANGUAGE_CONFIGURATION_${lang}_TOOLSET CACHE)
	endforeach()
	unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_LANGUAGE_CONFIGURATIONS CACHE)
	unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_EXTRA_TOOLS  CACHE)
	unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_EXTRA_TOOLS_INSTANCES  CACHE)
	...
	foreach(package IN LISTS ${PROJECT_NAME}_KNOWN_VERSION_${version}_DEPENDENCIES)
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_DEPENDENCY_${package}_VERSIONS CACHE)
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_DEPENDENCY_${package}_VERSIONS_EXACT CACHE)
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_DEPENDENCY_${package}_ALTERNATIVE_VERSION_USED CACHE)
	endforeach()
	unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_DEPENDENCIES CACHE)

	#reset components
	foreach(component IN LISTS ${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENTS)

		#reset information local to the component
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_FORCED_SHARED_LINKS CACHE)
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_SHARED_LINKS CACHE)
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_DEBUG_SUFFIX CACHE)
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_SONAME CACHE)
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_STATIC_LINKS CACHE)
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_INCLUDES CACHE)
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_DEFINITIONS CACHE)
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_OPTIONS CACHE)
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_C_STANDARD CACHE)
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_CXX_STANDARD CACHE)
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_RUNTIME_RESOURCES CACHE)
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_PYTHON_PACKAGES CACHE)


		#reset information related to system dependencies
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_SYSTEM_INCLUDES CACHE)
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_SYSTEM_LIB_DIRS CACHE)
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_SYSTEM_DEFINITIONS CACHE)
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_SYSTEM_OPTIONS CACHE)
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_SYSTEM_LINKS CACHE)
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_SYSTEM_C_STANDARD CACHE)
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_SYSTEM_CXX_STANDARD CACHE)
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_SYSTEM_RUNTIME_RESOURCES CACHE)
		...
		foreach(dependency IN LISTS ${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_INTERNAL_DEPENDENCIES)
			unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_INTERNAL_DEPENDENCY_${dependency}_DEFINITIONS CACHE)
			unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_INTERNAL_DEPENDENCY_${dependency}_EXPORTED CACHE)
		endforeach()
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_INTERNAL_DEPENDENCIES CACHE)
		...
		foreach(package IN LISTS ${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_DEPENDENCIES)
			...
			foreach(dependency IN LISTS ${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_DEPENDENCY_${package})
				unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_DEPENDENCY_${package}_${dependency}_DEFINITIONS CACHE)
				unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_DEPENDENCY_${package}_${dependency}_EXPORTED CACHE)
			endforeach()
			unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_DEPENDENCY_${package} CACHE)

			#then reset direct package level dependencies of the component
			unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_DEPENDENCY_${package}_CONTENT_INCLUDES CACHE)
			unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_DEPENDENCY_${package}_CONTENT_LIB_DIRS CACHE)
			unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_DEPENDENCY_${package}_CONTENT_SHARED CACHE)
			unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_DEPENDENCY_${package}_CONTENT_STATIC CACHE)
			unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_DEPENDENCY_${package}_CONTENT_DEFINITIONS CACHE)
			unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_DEPENDENCY_${package}_CONTENT_OPTIONS CACHE)
			unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_DEPENDENCY_${package}_CONTENT_C_STANDARD CACHE)
			unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_DEPENDENCY_${package}_CONTENT_CXX_STANDARD CACHE)
			unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_DEPENDENCY_${package}_CONTENT_RUNTIME_RESOURCES CACHE)
		endforeach()
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_DEPENDENCIES CACHE)
	endforeach()
	unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENTS CACHE)

	#reset aliases
	foreach(alias IN LISTS ${PROJECT_NAME}_KNOWN_VERSION_${version}_ALIASES)
		unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_ALIAS_${alias} CACHE)
	endforeach()
	unset(${PROJECT_NAME}_KNOWN_VERSION_${version}_ALIASES CACHE)
...
endforeach()
unset(${PROJECT_NAME}_KNOWN_VERSIONS CACHE)

#reset system configuration description
set(${PROJECT_NAME}_SYSTEM_CONFIGURATION_DEFINED FALSE CACHE INTERNAL "")
unset(${PROJECT_NAME}_EVAL_FILE CACHE)
foreach(var IN LISTS ${PROJECT_NAME}_RETURNED_VARIABLES)
	unset(${PROJECT_NAME}_${var}_RETURNED_VARIABLE CACHE)
endforeach()

unset(${PROJECT_NAME}_RETURNED_VARIABLES CACHE)
unset(${PROJECT_NAME}_FIND_PACKAGES CACHE)
unset(${PROJECT_NAME}_EVAL_LANGUAGES CACHE)
unset(${PROJECT_NAME}_EVAL_ADDITIONAL_CONTENT CACHE)
unset(${PROJECT_NAME}_USE_FILES CACHE)
unset(${PROJECT_NAME}_INSTALL_PACKAGES CACHE)
unset(${PROJECT_NAME}_INSTALL_PROCEDURE CACHE)
unset(${PROJECT_NAME}_REQUIRED_CONSTRAINTS CACHE)
unset(${PROJECT_NAME}_OPTIONAL_CONSTRAINTS CACHE)
foreach(constraint IN LISTS ${PROJECT_NAME}_IN_BINARY_CONSTRAINTS)
	unset(${PROJECT_NAME}_${constraint}_BINARY_VALUE CACHE)
endforeach()
unset(${PROJECT_NAME}_IN_BINARY_CONSTRAINTS CACHE)
unset(${PROJECT_NAME}_CONFIGURATION_DEPENDENCIES CACHE)

#reset user options
foreach(opt IN LISTS ${PROJECT_NAME}_USER_OPTIONS)
	unset(${PROJECT_NAME}_USER_OPTION_${opt}_TYPE CACHE)
	unset(${PROJECT_NAME}_USER_OPTION_${opt}_VALUE CACHE)
endforeach()
unset(${PROJECT_NAME}_USER_OPTIONS CACHE)
...
foreach(version IN LISTS ${PROJECT_NAME}_KNOWN_VERSIONS)
	...
	foreach(lang IN LISTS ${PROJECT_NAME}_KNOWN_VERSION_${version}_LANGUAGE_CONFIGURATIONS)
		...
		file(APPEND ${path_to_file} "set(${PROJECT_NAME}_KNOWN_VERSION_${version}_LANGUAGE_CONFIGURATION_${lang}_OPTIONAL ${${PROJECT_NAME}_KNOWN_VERSION_${version}_LANGUAGE_CONFIGURATION_${lang}_OPTIONAL} CACHE INTERNAL \"\")\n")
	...
	foreach(component IN LISTS ${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENTS)
		...
		file(APPEND ${path_to_file} "set(${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_DEBUG_SUFFIX ${${PROJECT_NAME}_KNOWN_VERSION_${version}_COMPONENT_${component}_DEBUG_SUFFIX} CACHE INTERNAL \"\")\n")
		...
		endforeach()
	endforeach()
	file(APPEND ${path_to_file} "set(${PROJECT_NAME}_KNOWN_VERSION_${version}_ALIASES ${${PROJECT_NAME}_KNOWN_VERSION_${version}_ALIASES} CACHE INTERNAL \"\")\n")
	foreach(alias IN LISTS ${PROJECT_NAME}_KNOWN_VERSION_${version}_ALIASES)
		file(APPEND ${path_to_file} "set(${PROJECT_NAME}_KNOWN_VERSION_${version}_ALIAS_${alias} ${${PROJECT_NAME}_KNOWN_VERSION_${version}_ALIAS_${alias}} CACHE INTERNAL \"\")\n")
	endforeach()
endforeach()
...
# .. ifmode:: internal
#
#  .. |init_wrapper_dependency_version_selection_option| replace:: ``init_wrapper_dependency_version_selection_option``
#  .. _init_wrapper_dependency_version_selection_option:
#
#  init_wrapper_dependency_version_selection_option
#  --------------------------------------------------
#
#   .. command:: init_wrapper_dependency_version_selection_option(ERROR dep_package optional possible_versions exact_versions)
#
#     Define the user option used to select a possible version of a given dependency.
#
#     :dep_package: the name of the dependency.
...
#     :exact_versions: the list of exact versions of the package.
#
#     :ERROR: output variable that is TRUE if an error occurred and selection is not possible
#
function(init_wrapper_dependency_version_selection_option ERROR dep_package optional possible_versions exact_versions)
	set(${ERROR} FALSE PARENT_SCOPE)
	...
	set(${CURRENT_MANAGED_VERSION}_${dep_package}_SELECTION_MESSAGE ${message_str} CACHE INTERNAL "")
	#1.B) creating the user cache entries
	if(NOT possible_versions) # no version constraint specified
		### setting default cache variable that user can directly manage "by-hand" ###
		set(${CURRENT_MANAGED_VERSION}_${dep_package}_ALTERNATIVE_VERSION_USED "ANY" CACHE STRING "${${CURRENT_MANAGED_VERSION}_${dep_package}_SELECTION_MESSAGE}")#no message since nothing to say to the user
	...
	if(NOT ${CURRENT_MANAGED_VERSION}_${dep_package}_ALTERNATIVE_VERSION_USED)#SPECIAL CASE: no value set by user (i.e. error of the user)!!
		if(optional)#hopefully the dependency is optional so we can force its deactivation
			set(${CURRENT_MANAGED_VERSION}_${dep_package}_ALTERNATIVE_VERSION_USED "NONE" CACHE STRING "${${CURRENT_MANAGED_VERSION}_${dep_package}_SELECTION_MESSAGE}" FORCE)#explicitlty deactivate the optional dependency (corrective action)
			...
			set(${CURRENT_MANAGED_VERSION}_${dep_package}_ALTERNATIVE_VERSION_USED ${default_version} CACHE STRING "${${CURRENT_MANAGED_VERSION}_${dep_package}_SELECTION_MESSAGE}" FORCE)
		endif()
		...
		if(possible_versions)#there is a constraint on usable versions
			...
			elseif(${CURRENT_MANAGED_VERSION}_${dep_package}_ALTERNATIVE_VERSION_USED STREQUAL "SYSTEM")
				if(NOT FORCED)
					...
					check_version_compatibility(COMPATIBLE ${dep_package} TRUE ${${PROJECT_NAME}_${dep_package}_VERSION} "${possible_versions}" "${exact_versions}")
					
					if(NOT COMPATIBLE)#no possible version found -> bad input of the user but may be automatically corrected
						set(${CURRENT_MANAGED_VERSION}_${dep_package}_ALTERNATIVE_VERSION_USED ${default_version} CACHE STRING "${${CURRENT_MANAGED_VERSION}_${dep_package}_SELECTION_MESSAGE}" FORCE)
						return()
					endif()
				else()
					#otherwise we need to check that the system version is in the possible range
					check_version_compatibility(COMPATIBLE ${dep_package} TRUE ${${PROJECT_NAME}_${dep_package}_VERSION} "${possible_versions}" "${exact_versions}")
					if(NOT COMPATIBLE)#no possible version found -> bad input of the user or dependent build
						if(optional)
							...
							message("[PID] ERROR : dependency ${dep_package} for package ${PROJECT_NAME} is forced to be system variant (${${dep_package}_VERSION}) but does not belong to the allowed version range.")
							return()	
						endif()
					endif()
				endif()
			else()#a version has been given explicitly (either from dependent build or directly by the user)
				check_version_compatibility(COMPATIBLE ${dep_package} TRUE ${${CURRENT_MANAGED_VERSION}_${dep_package}_ALTERNATIVE_VERSION_USED} "${possible_versions}" "${exact_versions}")
...
endfunction(init_wrapper_dependency_version_selection_option)
...
#
#    Define a dependency between the currently defined version of the external package and another external package. Internal counterpart of declare_PID_Wrapper_External_Dependency.
#
#      :dep_package: the name of external package that is the dependency.
...
### 1) setting user cache variable. The goal is to given users the control "by-hand" on the version used for a given dependency ###
init_wrapper_dependency_version_selection_option(ERROR ${dep_package} ${optional} "${list_of_versions}" "${exact_versions}")
if(ERROR)
	set(${NEED_EXIT} TRUE PARENT_SCOPE)
	return()
endif()
...
if(REQUIRED_VERSION) #the package is already used as a dependency in the current build process so we need to reuse the version already specified or use a compatible one instead
	if(FORCED AND NOT IS_SYSTEM)
		message("[PID] INFO : In ${PROJECT_NAME} version ${CURRENT_MANAGED_VERSION}, dependency ${dep_package} is forced to be system but. But incompatible Non OS version ${REQUIRED_VERSION} is already used in packages: ${RES_REQ}.")
		set(${NEED_EXIT} TRUE PARENT_SCOPE)
		return()
	endif()
	if(list_of_versions) #list of possible versions is constrained
		...
		if(NOT force_version)#the build context is a dependent build and no compatible version has been found
			if(optional)#hopefully the dependency is optional so we can deactivate it
				set(${CURRENT_MANAGED_VERSION}_${dep_package}_ALTERNATIVE_VERSION_USED "NONE" CACHE STRING "${${CURRENT_MANAGED_VERSION}_${dep_package}_SELECTION_MESSAGE}" FORCE)
		...
		#simply reset the description to first found
		set(${CURRENT_MANAGED_VERSION}_${dep_package}_ALTERNATIVE_VERSION_USED ${chosen_version_for_selection} CACHE STRING "${${CURRENT_MANAGED_VERSION}_${dep_package}_SELECTION_MESSAGE}" FORCE)
		...
		set(${CURRENT_MANAGED_VERSION}_${dep_package}_ALTERNATIVE_VERSION_USED ${chosen_version_for_selection} CACHE STRING "${${CURRENT_MANAGED_VERSION}_${dep_package}_SELECTION_MESSAGE}" FORCE)#explicitlty set the dependency to the chosen version number
	endif()
	...
	if(NOT ${CURRENT_MANAGED_VERSION}_${dep_package}_ALTERNATIVE_VERSION_USED)#SPECIAL CASE: no value set by user (i.e. error of the user)!!
		...
		elseif(list_of_possible_versions)#set if to default version
			...
			set(${CURRENT_MANAGED_VERSION}_${dep_package}_ALTERNATIVE_VERSION_USED "ANY" CACHE STRING "${${CURRENT_MANAGED_VERSION}_${dep_package}_SELECTION_MESSAGE}" FORCE)
		endif()
...
#      :debug_suffix: the suffix used for binaries when compiled in debug mode.
#
function(declare_Wrapped_Component component forced_shared_links shared_links soname static_links includes definitions options c_standard c_max_standard cxx_standard cxx_max_standard runtime_resources aliases python_packages debug_suffix)
...
set(${PROJECT_NAME}_KNOWN_VERSION_${CURRENT_MANAGED_VERSION}_COMPONENT_${component}_DEBUG_SUFFIX ${debug_suffix} CACHE INTERNAL "")
	...
	foreach(link IN LISTS all_symlinks)
		if(NOT link MATCHES "^-.+" #do not use linker scripts (e.g. link for system library)
			...
			if(EXISTS ${link})
				...
				message(WARNING "[PID] WARNING: rpath symlink cannot be created because ${link} is not a valid path")
			endif()
		endif()
	endforeach()
	if(list_of_symlinks)
...
#  -------------------------------
#
#   .. command:: create_Relative_Path_To_Shared(RES_BINARY var suffix package version component platform)
#
#    Append the description of a component dependencies to a given external package use file.
#
#      :var: variable containing the list of shared.
#      :suffix: suffix to use for binairies names
#      :package: the name of target external package.
#      :version: the target version of external package.
#      :component: the name of the component that may have dependencies.
#      :platform: the identifier of target platform in workspace install tree.
...
#      :RES_BINARY: the output variable containing the list of shared objects.
#
function(create_Relative_Path_To_Shared RES_BINARY var suffix package version component platform)
	set(${RES_BINARY} PARENT_SCOPE)
	...
	foreach(shared_lib_path IN LISTS ${var})
			create_Shared_Lib_Path(RESULT_LIB_PATH ${shared_lib_path} ${platform} "${USE_SONAME}" "${suffix}")
...
function(generate_Description_For_External_Component file_for_version package platform version component)
	...
	if(CMAKE_BUILD_TYPE MATCHES Debug)
		set(use_suffix ${${package}_KNOWN_VERSION_${version}_COMPONENT_${component}_DEBUG_SUFFIX})
	endif()
	if(${package}_KNOWN_VERSION_${version}_COMPONENT_${component}_FORCED_SHARED_LINKS)
		create_Relative_Path_To_Shared(RES_BIN_SHARED ${package}_KNOWN_VERSION_${version}_COMPONENT_${component}_FORCED_SHARED_LINKS "${use_suffix}" ${package} ${version} ${component} ${platform})
	...
	if(${package}_KNOWN_VERSION_${version}_COMPONENT_${component}_SHARED_LINKS)
		create_Relative_Path_To_Shared(RES_BIN_SHARED ${package}_KNOWN_VERSION_${version}_COMPONENT_${component}_SHARED_LINKS "${use_suffix}" ${package} ${version} ${component} ${platform})
		fill_String_From_List(RES_SHARED RES_BIN_SHARED " ")
	...
	foreach(component IN LISTS ${package}_KNOWN_VERSION_${version}_COMPONENTS)
		...
		if(		${package}_KNOWN_VERSION_${version}_COMPONENT_${component}_SHARED_LINKS
			...
			foreach(sha_link IN LISTS all_shared)
				...
				#also need to create symlinks for third party projects
				get_filename_component(FULL_EXT "${${package}_RPATH}" EXT)
				create_Shared_Lib_Extension(RES_EXT ${platform} "")
				if(FULL_EXT MATCHES "^${RES_EXT}((\\.[0-9]+)+)$")
...
function(set_Build_Info_For_Dependency prefix dep_package component)
	...
	############## Define initial value for LOCAL variables #########
	set(TEMP_LOCAL_LINKS)
	set(TEMP_LOCAL_INCLUDES)
	set(TEMP_LOCAL_LIB_DIRS)
	set(TEMP_LOCAL_DEFINITIONS)
	set(TEMP_LOCAL_COMPILER_OPTIONS)
	set(TEMP_LOCAL_RUNTIME_RESOURCES)
	set(TEMP_LOCAL_C_STANDARD)
	set(TEMP_LOCAL_CXX_STANDARD)
	...
	foreach(dep_component IN LISTS ${prefix}_COMPONENT_${component}_DEPENDENCY_${dep_package})
		...
		######### NOW set BUILD info for the given component #########
		evaluate_Variables_In_List(EVAL_BUILD_LNKS RES_LINKS) #first evaluate element of the list => if they are variables they are evaluated
		evaluate_Variables_In_List(EVAL_BUILD_INCS RES_INCS)
		evaluate_Variables_In_List(EVAL_BUILD_LDIRS RES_LIB_DIRS)
		evaluate_Variables_In_List(EVAL_BUILD_DEFS RES_DEFS)
		evaluate_Variables_In_List(EVAL_BUILD_OPTS RES_OPTS)
		evaluate_Variables_In_List(EVAL_BUILD_SHARED_LNKS RES_SHARED_LINKS) #first evaluate element of the list => if they are variables they are evaluated
		evaluate_Variables_In_List(EVAL_BUILD_RRES RES_RESOURCES)
		...
		remove_Duplicates_From_List(BUILD_COMPLETE_RESOURCES_PATH)

		set(${prefix}_DEPENDENCY_${dep_package}_COMPONENT_${dep_component}_BUILD_LINKS ${BUILD_COMPLETE_LINKS_PATH} CACHE INTERNAL "")
		set(${prefix}_DEPENDENCY_${dep_package}_COMPONENT_${dep_component}_BUILD_SHARED_LINKS ${BUILD_COMPLETE_SHARED_LINKS_PATH} CACHE INTERNAL "")
		set(${prefix}_DEPENDENCY_${dep_package}_COMPONENT_${dep_component}_BUILD_INCLUDES ${BUILD_COMPLETE_INCS_PATH} CACHE INTERNAL "")
		set(${prefix}_DEPENDENCY_${dep_package}_COMPONENT_${dep_component}_BUILD_LIB_DIRS ${BUILD_COMPLETE_LDIRS_PATH} CACHE INTERNAL "")
		set(${prefix}_DEPENDENCY_${dep_package}_COMPONENT_${dep_component}_BUILD_DEFINITIONS ${EVAL_BUILD_DEFS} CACHE INTERNAL "")
		set(${prefix}_DEPENDENCY_${dep_package}_COMPONENT_${dep_component}_BUILD_COMPILER_OPTIONS ${EVAL_BUILD_OPTS} CACHE INTERNAL "")
		set(${prefix}_DEPENDENCY_${dep_package}_COMPONENT_${dep_component}_BUILD_RUNTIME_RESOURCES ${BUILD_COMPLETE_RESOURCES_PATH} CACHE INTERNAL "")
		set(${prefix}_DEPENDENCY_${dep_package}_COMPONENT_${dep_component}_BUILD_C_STANDARD ${c_std} CACHE INTERNAL "")
		set(${prefix}_DEPENDENCY_${dep_package}_COMPONENT_${dep_component}_BUILD_C_MAX_STANDARD ${c_max_std} CACHE INTERNAL "")
		set(${prefix}_DEPENDENCY_${dep_package}_COMPONENT_${dep_component}_BUILD_CXX_STANDARD ${cxx_std} CACHE INTERNAL "")
		set(${prefix}_DEPENDENCY_${dep_package}_COMPONENT_${dep_component}_BUILD_CXX_MAX_STANDARD ${cxx_max_std} CACHE INTERNAL "")

		#### NOW LOCAL info for a given component
		#options, definitions and includes
		evaluate_Variables_In_List(EVAL_LOCAL_OPTS ${dep_package}_${dep_component}_OPTS${VAR_SUFFIX})
		evaluate_Variables_In_List(EVAL_LOCAL_INCS ${dep_package}_${dep_component}_INC_DIRS${VAR_SUFFIX})
		evaluate_Variables_In_List(EVAL_LOCAL_DEFS ${dep_package}_${dep_component}_DEFS${VAR_SUFFIX})
		remove_Duplicates_From_List(EVAL_LOCAL_OPTS)
		remove_Duplicates_From_List(EVAL_LOCAL_DEFS)
		remove_Duplicates_From_List(EVAL_LOCAL_INCS)
		...
		foreach(a_link IN LISTS EVAL_LOCAL_LINKS)
			if(NOT a_link MATCHES "^(-|/)l.+$")
				#not a system link
				list(APPEND res_links ${a_link})
			endif()
		endforeach()
		set(${dep_package}_${dep_component}_LOCAL_LINKS ${res_links} CACHE INTERNAL "")
		#library dirs
		set(ALL_LOCAL_LIB_DIRS)
		get_Library_Dirs_For_Links(ALL_LOCAL_LIB_DIRS ${dep_package} res_links)
		...
		set(${dep_package}_${dep_component}_LOCAL_CXX_STANDARD ${RES_STD_CXX} CACHE INTERNAL "")
		list(APPEND TEMP_LOCAL_LINKS ${${dep_package}_${dep_component}_LOCAL_LINKS})
		list(APPEND TEMP_LOCAL_INCLUDES ${${dep_package}_${dep_component}_LOCAL_INCLUDES})
		list(APPEND TEMP_LOCAL_LIB_DIRS ${${dep_package}_${dep_component}_LOCAL_LIB_DIRS})
		list(APPEND TEMP_LOCAL_DEFINITIONS ${${dep_package}_${dep_component}_LOCAL_DEFINITIONS})
		list(APPEND TEMP_LOCAL_COMPILER_OPTIONS ${${dep_package}_${dep_component}_LOCAL_COMPILER_OPTIONS})
		list(APPEND TEMP_LOCAL_RUNTIME_RESOURCES ${${dep_package}_${dep_component}_LOCAL_RUNTIME_RESOURCES})
	endforeach()
	...
	# set the gloal BUILD variables adequately
	...
	#set the BUILD variables for the package
	remove_Duplicates_From_List(TEMP_LOCAL_LINKS)
	remove_Duplicates_From_List(TEMP_LOCAL_INCLUDES)
	remove_Duplicates_From_List(TEMP_LOCAL_LIB_DIRS)
	remove_Duplicates_From_List(TEMP_LOCAL_DEFINITIONS)
	remove_Duplicates_From_List(TEMP_LOCAL_COMPILER_OPTIONS)
	remove_Duplicates_From_List(TEMP_LOCAL_RUNTIME_RESOURCES)
	set(${dep_package}_LOCAL_DEFINITIONS ${TEMP_LOCAL_DEFINITIONS} CACHE INTERNAL "")
	set(${dep_package}_LOCAL_COMPILER_OPTIONS ${TEMP_LOCAL_COMPILER_OPTIONS} CACHE INTERNAL "")
	set(${dep_package}_LOCAL_INCLUDES ${TEMP_LOCAL_INCLUDES} CACHE INTERNAL "")
	set(${dep_package}_LOCAL_LINKS ${TEMP_LOCAL_LINKS} CACHE INTERNAL "")
	set(${dep_package}_LOCAL_LIB_DIRS ${TEMP_LOCAL_LIB_DIRS} CACHE INTERNAL "")
	set(${dep_package}_LOCAL_RUNTIME_RESOURCES ${TEMP_LOCAL_RUNTIME_RESOURCES} CACHE INTERNAL "")
	set(${dep_package}_LOCAL_C_STANDARD ${c_std} CACHE INTERNAL "")
	set(${dep_package}_LOCAL_CXX_STANDARD ${cxx_std} CACHE INTERNAL "")
...
function(set_Build_Info_For_Component package component version platform)
	...
	create_Relative_Path_To_Shared(RELATIVE_BIN_SHARED ${package}_KNOWN_VERSION_${version}_COMPONENT_${component}_SHARED_LINKS "${use_suffix}" ${package} ${version} ${component} ${platform})
	...
	endforeach()
	create_Relative_Path_To_Shared(RELATIVE_BIN_SHARED ${package}_KNOWN_VERSION_${version}_COMPONENT_${component}_FORCED_SHARED_LINKS "${use_suffix}" ${package} ${version} ${component} ${platform})
	foreach(bin IN LISTS RELATIVE_BIN_SHARED)
		transform_External_Link_Into_Absolute_Path_Expression(RES_LINK ${package} ${bin})
		list(APPEND local_shared ${RES_LINK})
	endforeach()
...
function(resolve_Wrapper_Language_Configuration CONFIGURED package version)
	...
	foreach(lang IN LISTS ${package}_KNOWN_VERSION_${version}_LANGUAGE_CONFIGURATIONS)
		...
		if(NOT SYSCHECK_RESULT)
			...
			if(NOT ${package}_KNOWN_VERSION_${version}_LANGUAGE_CONFIGURATION_${lang}_OPTIONAL)
				...
				message("[PID] ERROR : when building ${package} version ${version}, language ${lang} is not defined by current profile !")
			endif()
		else()#OK language is available let's test its toolset if any
			...
			if(${package}_KNOWN_VERSION_${version}_LANGUAGE_CONFIGURATION_${lang}_TOOLSET)
				...
				if(NOT RESULT_OK)
					if(NOT ${package}_KNOWN_VERSION_${version}_LANGUAGE_CONFIGURATION_${lang}_OPTIONAL)
						set(IS_CONFIGURED FALSE)
						message("[PID] ERROR : ${package} version ${version} cannot satisfy toolset configuration ${${package}_KNOWN_VERSION_${version}_LANGUAGE_CONFIGURATION_${lang}_TOOLSET} for language ${lang} !")
					endif()
				endif()
			endif()
		endif()
	...
	if(INDEX EQUAL -1)
		...
		set(${package}_KNOWN_VERSION_${version}_LANGUAGE_CONFIGURATION_C_OPTIONAL FALSE CACHE INTERNAL "")
	endif()
	...
	if(INDEX EQUAL -1)
		...
		set(${package}_KNOWN_VERSION_${version}_LANGUAGE_CONFIGURATION_CXX_OPTIONAL FALSE CACHE INTERNAL "")
	endif()
...
elseif(${prefix}_DEPENDENCY_${dep_package}_ALTERNATIVE_VERSION_USED STREQUAL "SYSTEM" #the system version has been selected => need to perform specific actions
	...
	#need to detect the version in order to pass it to add_External_Package_Dependency_To_Cache
