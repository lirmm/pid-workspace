...
if(${package}_PUBLIC_ADDRESS OR ${package}_ADDRESS)
  ...
  set(DOC_STR "${DOC_STR}\nTo get last version :\n")
  set(DOC_STR "${DOC_STR} ```\ncd <path to pid workspace>\npid deploy package=${package}\n```\n")
  set(DOC_STR "${DOC_STR}\nTo get a specific version of the package :\n")
  set(DOC_STR "${DOC_STR} ```\ncd <path to pid workspace>\npid deploy package=${package} version=<version number>\n```\n")
  set(DOC_STR "${DOC_STR}\n## Standalone install\n")
  ...
  set(DOC_STR "${DOC_STR}\n```\npkg-config --variable=c_standard ${package}_<name of library>\n```\n")
  set(DOC_STR "${DOC_STR}\n```\npkg-config --variable=cxx_standard ${package}_<name of library>\n```\n")
...
if(${PROJECT_NAME}_SITE_GIT_ADDRESS) #the package is outside any framework
	...
	if(NOT FRAMEWORK_OK)
    finish_Progress(${GLOBAL_PROGRESS_VAR})
		message(FATAL_ERROR "[PID] CRITICAL ERROR : the framework you specified (${${PROJECT_NAME}_FRAMEWORK}) is unknown in the workspace.")
		return()
	endif()
