...
function(transform_Markdown_To_Jekyll label input_file output_jekyll)
	...
	set(header "")
	if(insert_header)
		if(label STREQUAL "advanced" OR label STREQUAL "tutorial")
			set(header "---\nlayout: package\npackage: ${PROJECT_NAME}\ntitle: ${label}\n---\n\n")
		else()
...
if(${CMAKE_BUILD_TYPE} MATCHES Release)
	...
	if(NOT ADDRESS)#no site description has been provided nor framework reference
		...
		if(${PROJECT_NAME}_DEV_INFO_AUTOMATIC_PUBLISHING)
			...
			project_Has_Tests_Or_Examples(TEST_DOC EXDOC)
			if(TEST_DOC)
...
function(generate_Package_Content_Documentation RETURNED_CONTENT_DOC package)
  ...
  foreach(comp IN LISTS ${package}_DECLARED_COMPS)
    ...
    elseif(${package}_${comp}_TYPE STREQUAL EXAMPLE)
      list(APPEND PACKAGE_EXAMPLES ${comp})
    elseif(${package}_${comp}_TYPE STREQUAL TEST)
      list(APPEND PACKAGE_TESTS ${comp})
	elseif(${package}_${comp}_TYPE STREQUAL PYTHON)
      list(APPEND PACKAGE_SCRIPTS ${comp})
	else()
	  list(APPEND PACKAGE_LIBS ${comp})
    endif()
  endforeach()

  list(LENGTH PACKAGE_LIBS NB_LIBS)
  list(LENGTH PACKAGE_EXECUTABLES NB_APPS)
  list(LENGTH PACKAGE_EXAMPLES NB_EXAMPLES)
  list(LENGTH PACKAGE_TESTS NB_TESTS)
  list(LENGTH PACKAGE_SCRIPTS NB_SCRIPTS)
  ...
  if(NB_LIBS GREATER 0)
    set(DOC_STR "${DOC_STR}\n * Libraries:\n")
    foreach(lib IN LISTS PACKAGE_LIBS)
  ...
  if(NB_SCRIPTS GREATER 0)
    set(DOC_STR "${DOC_STR}\n * Scripts:\n")
    foreach(script IN LISTS PACKAGE_SCRIPTS)
