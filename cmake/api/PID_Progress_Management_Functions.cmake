...
message("get_Dependency_Resolution_Path_For_Impl_Recurse mode=${mode}")
...
message("${package}_CHOSEN_VERSION_IN_CURRENT_PROCESS_REQUESTORS=${${package}_CHOSEN_VERSION_IN_CURRENT_PROCESS_REQUESTORS}")
if(${package}_CHOSEN_VERSION_IN_CURRENT_PROCESS_REQUESTORS)
	foreach(req IN LISTS ${package}_CHOSEN_VERSION_IN_CURRENT_PROCESS_REQUESTORS)
		...
		if(PACK_TYPE STREQUAL "NATIVE")
			if(${req}_DEPENDENCY_${package}_VERSION${VAR_SUFFIX})
				...
				set(requirer_dep " -> ${package} (no version)")
			endif()
		else()
		...
		set(TO_APPEND)
		message("recursion : get_Dependency_Resolution_Path_For_Impl_Recurse(${req} ${NEXT_REQUESTOR_INDENT} ${mode})")
