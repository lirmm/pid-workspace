...
function(write_Platform_Description file)
	...
	file(APPEND ${file} "set(CURRENT_PACKAGING_SYSTEM_CMD_INSTALL ${CURRENT_PACKAGING_SYSTEM_CMD_INSTALL} CACHE INTERNAL \"\" FORCE)\n")
	file(APPEND ${file} "set(CURRENT_PACKAGING_SYSTEM_CMD_UPDATE ${CURRENT_PACKAGING_SYSTEM_CMD_UPDATE} CACHE INTERNAL \"\" FORCE)\n")
	file(APPEND ${file} "set(CURRENT_PACKAGING_SYSTEM_CMD_UPGRADE ${CURRENT_PACKAGING_SYSTEM_CMD_UPGRADE} CACHE INTERNAL \"\" FORCE)\n")
	...
	file(APPEND ${file} "set(CURRENT_PYTHON_PACKAGER_INSTALL_CMD ${CURRENT_PYTHON_PACKAGER_INSTALL_CMD} CACHE INTERNAL \"\" FORCE)\n")
...
function(write_Workspace_Global_Info_File file)
	...
	separate_arguments(AVOID_SYSTEM_DEPENDENCIES)
	...
	file(APPEND ${file} "set(AVOID_SYSTEM_DEPENDENCIES ${AVOID_SYSTEM_DEPENDENCIES} CACHE INTERNAL \"\" FORCE)\n")
