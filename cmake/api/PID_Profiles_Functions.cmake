...
#  -------------------------------------------
#
#   .. command:: check_Language_Configuration_With_Arguments(CHECK_OK BINARY_CONTRAINTS CONFIGS_TO_CHECK lang_name lang_args mode)
#
...
#
function(check_Language_Configuration_With_Arguments CHECK_OK BINARY_CONTRAINTS CONFIGS_TO_CHECK lang_name lang_args mode)
  ...
  get_Configuration_Expression_Resulting_Constraints(PLAT_CONSTRAINTS ${lang_name} LANG_${lang_name}_PLATFORM_CONSTRAINTS)
  ...
  set(${CONFIGS_TO_CHECK} ${PLAT_CONSTRAINTS} PARENT_SCOPE)
