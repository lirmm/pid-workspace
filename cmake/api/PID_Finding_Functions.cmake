...
#  --------------------------------------------------------
#
#   .. command:: is_External_Version_Compatible_With_Previous_Constraints(IS_COMPATIBLE package version)
#
...
foreach(a_used_package IN LISTS ${PROJECT_NAME}_ALL_USED_EXTERNAL_PACKAGES)
	unset(${a_used_package}_FOUND${VAR_SUFFIX} CACHE)
	unset(${a_used_package}_ROOT_DIR CACHE)
	unset(${a_used_package}_ALL_REQUIRED_VERSIONS CACHE)
	unset(${a_used_package}_REQUIRED_VERSION_EXACT CACHE)
	unset(${a_used_package}_REQUIRED_VERSION_SYSTEM CACHE)
endforeach()
unset(${PROJECT_NAME}_ALL_USED_EXTERNAL_PACKAGES CACHE)
