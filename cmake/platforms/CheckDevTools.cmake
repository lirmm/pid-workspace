...
if(PID_CROSSCOMPILATION)#cannot patch elf object
  set(RPATH_UTILITY ${PID_USE_RPATH_UTILITY} CACHE INTERNAL "" FORCE)
else()
  if(CMAKE_HOST_APPLE)
...
if(DOXYGEN_FOUND)
  ...
  set(DOXYGEN_DOT_EXECUTABLE ${DOXYGEN_DOT_EXECUTABLE} CACHE INTERNAL "" FORCE)
  find_package(LATEX)
  ...
  set(DOXYGEN_DOT_EXECUTABLE CACHE INTERNAL "" FORCE)
...
if(PID_CROSSCOMPILATION)
  #code coverage tools are not usable when crosscompiling (cannot run tests anyway)
  if(PID_USE_C_COVERAGE)
    set(GCOV_EXECUTABLE ${PID_USE_C_COVERAGE} CACHE INTERNAL "" FORCE)
  elseif(PID_USE_CXX_COVERAGE)
...
if(GCOV_EXECUTABLE)
  ...
  elseif(CMAKE_COMPILER_IS_GNUCXX)
    ...
    if(GCOVR_PATH)
      set(LCOV_EXECUTABLE ${GCOVR_PATH} CACHE INTERNAL "" FORCE)
      set(GENHTML_EXECUTABLE ${GCOVR_PATH} CACHE INTERNAL "" FORCE)
