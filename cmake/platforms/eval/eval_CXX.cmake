      ...
      if(constraint MATCHES "^(.+)-(.+)$")
        if(CMAKE_MATCH_1 STREQUAL CURRENT_CXX_COMPILER)
          if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS CMAKE_MATCH_2)
            message(FATAL_ERROR "[PID] CRITICAL ERROR: ${CURRENT_CXX_COMPILER} C++ compiler version ${CMAKE_CXX_COMPILER_VERSION} < ${CMAKE_MATCH_2}, constraint violated")
          endif()
        break()
        endif()
      endif()
      ...
      if(constraint MATCHES "^(.+)-(.+)$")
        if(CMAKE_MATCH_1 STREQUAL CXX_STD_LIBRARY_NAME)
          if(CXX_STD_LIBRARY_VERSION VERSION_LESS CMAKE_MATCH_2)
            message(FATAL_ERROR "[PID] CRITICAL ERROR: ${CXX_STD_LIBRARY_NAME} C++ standard library version ${CXX_STD_LIBRARY_VERSION} < ${CMAKE_MATCH_2}, constraint violated")
          endif()
        break()
        endif()
      endif()
