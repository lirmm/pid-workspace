...
if(Python_Language_AVAILABLE)#if python is available we should provide a package for it
  if(CURRENT_DISTRIBUTION STREQUAL "arch")
    ...
    set(CURRENT_PYTHON_PACKAGER_EXE ${CURRENT_PACKAGING_SYSTEM_CMD_INSTALL} CACHE INTERNAL "")
    set(CURRENT_PYTHON_PACKAGER_EXE_OPTIONS CACHE INTERNAL "")
  else()
    ...
    if(pip_installed)
      ...
      set(CURRENT_PYTHON_PACKAGER_EXE ${CURRENT_PYTHON_EXECUTABLE} -m pip install CACHE INTERNAL "")
      set(CURRENT_PYTHON_PACKAGER_EXE_OPTIONS CACHE INTERNAL "")
    endif()
    unset(pip_installed)
  endif()
