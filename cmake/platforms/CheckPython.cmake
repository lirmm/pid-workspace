...
set(CURRENT_PYTHON_PACKAGER_INSTALL_CMD CACHE INTERNAL "")
if(Python_Language_AVAILABLE)#if python is available we should provide a package for it
  if(CURRENT_DISTRIBUTION STREQUAL "arch")
    ...
    set(CURRENT_PYTHON_PACKAGER_INSTALL_CMD ${CURRENT_PACKAGING_SYSTEM_CMD_INSTALL} CACHE INTERNAL "")
  else()
    ...
    if(pip_installed)
      ...
      set(CURRENT_PYTHON_PACKAGER_INSTALL_CMD ${CURRENT_PYTHON_PACKAGER_EXE} install CACHE INTERNAL "")
    endif()
    unset(pip_installed)
  endif()
endif()
