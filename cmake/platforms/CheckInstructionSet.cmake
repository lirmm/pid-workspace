...
set(CPU_SSE_TEST_FILE "${WORKSPACE_DIR}/cmake/platforms/checks/cpu_sse.cpp")
set(CPU_SSE2_TEST_FILE "${WORKSPACE_DIR}/cmake/platforms/checks/cpu_sse2.cpp")
set(CPU_SSE3_TEST_FILE "${WORKSPACE_DIR}/cmake/platforms/checks/cpu_sse3.cpp")
set(CPU_SSSE3_TEST_FILE "${WORKSPACE_DIR}/cmake/platforms/checks/cpu_ssse3.cpp")
set(CPU_SSE4_1_TEST_FILE "${WORKSPACE_DIR}/cmake/platforms/checks/cpu_sse41.cpp")
set(CPU_SSE4_2_TEST_FILE "${WORKSPACE_DIR}/cmake/platforms/checks/cpu_sse42.cpp")
set(CPU_POPCNT_TEST_FILE "${WORKSPACE_DIR}/cmake/platforms/checks/cpu_popcnt.cpp")
set(CPU_AVX_TEST_FILE "${WORKSPACE_DIR}/cmake/platforms/checks/cpu_avx.cpp")
set(CPU_AVX2_TEST_FILE "${WORKSPACE_DIR}/cmake/platforms/checks/cpu_avx2.cpp")
set(CPU_FP16_TEST_FILE "${WORKSPACE_DIR}/cmake/platforms/checks/cpu_fp16.cpp")
set(CPU_AVX_512F_TEST_FILE "${WORKSPACE_DIR}/cmake/platforms/checks/cpu_avx512.cpp")
set(CPU_AVX512_SKX_TEST_FILE "${WORKSPACE_DIR}/cmake/platforms/checks/cpu_avx512skx.cpp")
set(CPU_NEON_TEST_FILE "${WORKSPACE_DIR}/cmake/platforms/checks/cpu_neon.cpp")
set(CPU_VSX_TEST_FILE "${WORKSPACE_DIR}/cmake/platforms/checks/cpu_vsx.cpp")
set(CPU_VSX3_TEST_FILE "${WORKSPACE_DIR}/cmake/platforms/checks/cpu_vsx3.cpp")
...
if(CURRENT_PLATFORM_TYPE STREQUAL x86)
...
elseif(CURRENT_PLATFORM_TYPE STREQUAL arm)
  if(CURRENT_PLATFORM_ARCH EQUAL 32)
    set(CPU_KNOWN_OPTIMIZATIONS VFPV3 NEON FP16)
  elseif(CURRENT_PLATFORM_ARCH EQUAL 64)
    set(CPU_KNOWN_OPTIMIZATIONS NEON FP16)
  endif()
elseif(CURRENT_PLATFORM_TYPE STREQUAL ppc)
...
if(CURRENT_PLATFORM_TYPE STREQUAL "x86")
  if(CURRENT_C_COMPILER STREQUAL "icc")#C compiler is icc (specific case)
    ...
    if(NOT CURRENT_PLATFORM_ARCH EQUAL 64) # x64 compiler doesn't support /arch:sse
