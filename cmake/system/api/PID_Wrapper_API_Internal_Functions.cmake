...
if(DIR_NAME STREQUAL "build")
	  ...
	  #################################################
	    ...
	    ${CMAKE_COMMAND}	-DWORKSPACE_DIR=${WORKSPACE_DIR}
	           ...
	           -DDO_NOT_EXECUTE_SCRIPT=\${skip_script}
						 ...
						 -P ${WORKSPACE_DIR}/cmake/system/commands/Build_PID_Wrapper.cmake
		...
		add_custom_target(uninstall
			${CMAKE_COMMAND}	-DWORKSPACE_DIR=${WORKSPACE_DIR}
	           -DTARGET_EXTERNAL_PACKAGE=${PROJECT_NAME}
	           -DTARGET_EXTERNAL_VERSION=\${version}
						 -P ${WORKSPACE_DIR}/cmake/system/commands/Uninstall_PID_Wrapper.cmake
	  ...
	  add_custom_target(memorizing
			...
			-P ${WORKSPACE_DIR}/cmake/system/commands/Memorizing_PID_Wrapper_Version.cmake
	  	WORKING_DIRECTORY ${CMAKE_BINARY_DIR}
