...
if(DIR_NAME STREQUAL "build")
	...
	add_custom_target(build
		COMMAND ${CMAKE_COMMAND}	-DWORKSPACE_DIR=${WORKSPACE_DIR}
						...
						-P ${WORKSPACE_DIR}/cmake/system/commands/Build_PID_Package_Site.cmake
		WORKING_DIRECTORY ${CMAKE_BINARY_DIR}
	...
	add_custom_target(serve
		COMMAND ${CMAKE_COMMAND}	-DWORKSPACE_DIR=${WORKSPACE_DIR}
						...
						-P ${WORKSPACE_DIR}/cmake/system/commands/Serve_PID_Package_Site.cmake
		WORKING_DIRECTORY ${CMAKE_BINARY_DIR}
...
if(DIR_NAME STREQUAL "build")
	...
	add_custom_target(build
		COMMAND ${CMAKE_COMMAND}	-DFRAMEWORK_PATH=${CMAKE_SOURCE_DIR}
						...
						-DJEKYLL_EXECUTABLE=${JEKYLL_EXECUTABLE}
						-P ${WORKSPACE_DIR}/cmake/system/commands/Build_PID_Framework.cmake
		WORKING_DIRECTORY ${CMAKE_BINARY_DIR}
	...
	add_custom_target(serve
		COMMAND ${CMAKE_COMMAND}	-DFRAMEWORK_PATH=${CMAKE_SOURCE_DIR}
						...
						-P ${WORKSPACE_DIR}/cmake/system/commands/Serve_PID_Framework.cmake
		WORKING_DIRECTORY ${CMAKE_BINARY_DIR}
