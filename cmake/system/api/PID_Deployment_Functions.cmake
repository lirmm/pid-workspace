...
foreach(dep_ext_pack IN LISTS ${package}_EXTERNAL_DEPENDENCIES${VAR_SUFFIX})
    ...
    if(REQUIRED_PACKAGES_AUTOMATIC_DOWNLOAD) #download or clone of dependencies is automatic
      ...
      if(NOT INSTALL_OK)
        finish_Progress(${GLOBAL_PROGRESS_VAR})
        message(FATAL_ERROR "[PID] CRITICAL ERROR : impossible to install external package: ${dep_ext_pack}. This bug is maybe due to bad referencing of this package. Please have a look in workspace and try to find ReferExternal${dep_ext_pack}.cmake file in cmake/references folder.")
  			return()
  		endif()
...
foreach(dep_pack IN LISTS ${package}_DEPENDENCIES${VAR_SUFFIX})
    ...
    if(REQUIRED_PACKAGES_AUTOMATIC_DOWNLOAD) #download or clone of dependencies is automatic
      ...
      if(NOT INSTALL_OK)
        finish_Progress(${GLOBAL_PROGRESS_VAR})
        message(FATAL_ERROR "[PID] CRITICAL ERROR : impossible to install native package: ${dep_pack}. This bug is maybe due to bad referencing of this package. Please have a look in workspace and try to fond Refer${dep_pack}.cmake file in cmake/references folder.")
				return()
  		endif()
