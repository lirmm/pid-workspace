...
function(get_Environment_Configuration environment)
  ...
  find_On_Demand_Tool_Prefix(TOOL_PREFIX ${environment})
  if(NOT TOOL_PREFIX)
    #in case a prefix is not defined (automatic plugins that are not "on demand" by wrappers/packages)
    find_Automatic_Tool_Prefix_For_Current_Profile(TOOL_PREFIX ${environment})
    if(NOT TOOL_PREFIX)
