...
# .. ifmode:: user
#
#  .. |declare_PID_Wrapper_System_Configuration| replace:: ``declare_PID_Wrapper_System_Configuration``
#  .. _declare_PID_Wrapper_System_Configuration:
#
#  declare_PID_Wrapper_System_Configuration
#  ----------------------------------------
#
#   .. command:: declare_PID_Wrapper_System_Configuration(name VARIABLES ... VALUES ...)
#
#   .. command:: PID_Wrapper_System_Configuration_Variables(name VARIABLES ... VALUES ...)
#
...
#        declare_PID_Wrapper_System_Configuration(boost
...
#        )
#        PID_Wrapper_System_Configuration_Variables(boost
#          VARIABLES VERSION       LIBRARY_DIRS        INCLUDE_DIRS        RPATH
#          VALUES    BOOST_VERSION Boost_LIBRARY_DIRS  Boost_INCLUDE_DIRS  Boost_LIBRARY_DIRS
#        )
#
...
function(declare_PID_Wrapper_System_Configuration)
  ...
  set(multiValueArg ${PID_KNOWN_PACKAGING_SYSTEMS} FIND_PACKAGES VARIABLES VALUES) #the value may be a list
  ...
  if(DECLARE_PID_CONFIGURATION_VARIABLES OR DECLARE_PID_CONFIGURATION_VALUES)
    ...
    if(NOT SIZE_VARS EQUAL SIZE_VALS)
      message("[PID] WARNING: Bad usage of function PID_Wrapper_System_Configuration, you must give the a value (the name of the variable holding the value to set) for each variable defined using VARIABLES keyword. ")
    else()
